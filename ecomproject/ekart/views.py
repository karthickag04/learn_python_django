...
from ekart.forms import CustomUserForm
from . models import *
...
def favviewpage(request):
  if request.user.is_authenticated:
    ...
    return render(request,"ekart/fav.html",{"fav":fav})
  else:
    return redirect("/")
...
def cart_page(request):
  if request.user.is_authenticated:
    ...
    return render(request,"ekart/cart.html",{"cart":cart})
  else:
    return redirect("/")
...
def collections(request):
  ...
  return render(request,"ekart/collections.html",{"catagory":catagory})
